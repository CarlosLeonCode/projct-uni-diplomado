        ...
        <div class="d-flex justify-content-center">
          ...
          <div class="card card-default w-50 shadow border-0">
            <div class="card-header border-0 p-3">
              <span class="card-title">{{ __('Actualizar') }} Mantenimiento</span>
            </div>
            <div class="card-body">
              <form method="POST" action="{{ route('maintances.update', $maintance->id) }}"  role="form" enctype="multipart/form-data">
                {{ method_field('PATCH') }}
                @csrf
