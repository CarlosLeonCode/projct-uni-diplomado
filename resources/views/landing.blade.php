    ...
    <div class="container px-5">
      <div class="section-title">
        ...
        <form>
          ...
          <div class="mb-3 form-check">
            <label for="lastnamesField" class="form-label">Apellidos</label>
            <input type="text" class="form-control" id="lastnamesField" aria-describedby="nameHelp">
          </div>
          <div class="mb-3 form-check">
            <label for="phoneField" class="form-label">Teléfono</label>
            <input type="text" class="form-control" id="phoneField" aria-describedby="nameHelp">
          </div>
          <div class="mb-3 form-check">
            <label for="phoneField" class="form-label">Género</label>
            <input type="text" class="form-control" id="phoneField" aria-describedby="nameHelp">
          </div>
          <div class="mb-3 form-check">
            <label for="emailField" class="form-label">Correo</label>
