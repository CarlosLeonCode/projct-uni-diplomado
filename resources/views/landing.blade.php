      ...
      <div id="carouselExampleDark" class="carousel carousel-dark slide" data-bs-ride="carousel">
        ...
        <div class="carousel-inner">
          <div class="carousel-item active" data-bs-interval="10000">
            <img src="{{URL::asset('img/carrusel1.jpg')}}" style="width: 360px; height: 650px;" class="d-block w-100"
              alt="...">
            <div class="carousel-caption d-none d-md-block">
            </div>
          </div>
          <div class="carousel-item" data-bs-interval="2000">
            <img src="{{URL::asset('img/carrusel2.jpg')}}" style="width: 360px; height: 650px;" class="d-block w-100"
              alt="...">
            <div class="carousel-caption d-none d-md-block">
            </div>
          </div>
          <div class="carousel-item">
            <img src="{{URL::asset('img/carrusel3.jpg')}}" style="width: 360px; height: 650px;" class="d-block w-100"
              alt="...">
            <div class="carousel-caption d-none d-md-block">
            </div>
          </div>
  ...
  <div class="container">
    <div class="section-title mt-5">
      ...
      <p>
        ...
        alias facilis repudiandae soluta aut exercitationem vel omnis rerum quaerat sit optio culpa fugiat? Quas.
        Lorem ipsum dolor sit amet consectetur adipisicing elit. Temporibus commodi, cum, totam consectetur hic illo
        alias facilis repudiandae soluta aut exercitationem vel omnis rerum quaerat sit optio culpa fugiat? Quas.
        Lorem ipsum dolor sit amet consectetur adipisicing elit. Temporibus commodi, cum, totam consectetur hic illo
        alias facilis repudiandae soluta aut exercitationem vel omnis rerum quaerat sit optio culpa fugiat? Quas.
...
<section id="contacto" class="contacto section-bg">
  ...
  <div>
    ...
    <iframe style="border:0; width: 100%; height: 350px;"
      src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3976.8624328658157!2d-74.13113028543113!3d4.618620143650318!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x8e3f9eadf032a39d%3A0x8e0fd6d7cc83ab82!2sCra.%2068f%20%234-26%2C%20Bogot%C3%A1!5e0!3m2!1ses!2sco!4v1675984525470!5m2!1ses!2sco"
        ...
        <div class="col-lg-3 col-md-6 footer-links">
          ...
          <ul>
            <li><i class="bx bx-chevron-right"></i> <a
                href="https://github.com/shr7irley/ProyectoUniversidad">GitHub</a></li>
            <li><i class="bx bx-chevron-right"></i> <a href="https://aulavirtual.ibero.edu.co/login/index.php">Ibero</a>
            </li>
